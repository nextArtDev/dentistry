  ...
  return (
    <ReactLenis root>
      <main className="bg-black">
        ...
        <section className="text-white mx-auto  w-full bg-white  ">
          <div className="grid ">
            <div className="sticky border border-red-500 top-0 h-screen w-full flex items-center justify-center">
              {/* <h1 className="2xl:text-7xl text-5xl px-8 font-semibold text-center tracking-tight leading-[120%]">
                Thanks To Scroll.
              ...
              <section
                className="w-[96%] md:w-fit mx-auto m-2 overflow-hidden"
                style={{ clipPath: 'url(#clip-another2)' }}
              >
                {/* <img
            ...
            <div className="grid place-content-center place-items-center gap-2">
              ...
              {/* <figure className="grid place-content-center  ">
                <img
                  src="https://images.unsplash.com/photo-1718838541476-d04e71caa347?w=500&auto=format&fit=crop"
                  alt=""
                  className="transition-all duration-300 w-52 h-96  align-bottom object-cover "
                />
              </figure> */}
              <figure
                style={{ clipPath: 'url(#clip-another)' }}
                className="w-52 h-auto  py-12   z-10 p-8 group  hover:p-4 transition-all duration-200 bg-gradient-to-b to-[#02264122] from-[#35677822] rounded-xl backdrop-blur-sm"
              >
                <div dir="rtl" style={{ clipPath: 'url(#clip-another)' }}>
                  {/* <img
                    className="w-52 h-96 transition-all duration-300 align-bottom  aspect-square object-cover group-hover:scale-110 w-full"
                    src="https://images.unsplash.com/photo-1681238093193-1b3a8fcdf225?q=80&w=1962&auto=format&fit=crop"
                    alt=""
                  /> */}
                  <ul className="   backdrop-blur-sm py-6 px-4">
                    <li className=" ">ایتم اول</li>
                    <li className=" ">ایتم دوم</li>
                    <li className=" ">ایتم دوم</li>
                    <li className=" ">ایتم دوم</li>
                  </ul>
                </div>
              ...
              >
                <div dir="rtl" style={{ clipPath: 'url(#clip-another)' }}>
                  <ul className="shadow shadow-indigo-200    backdrop-blur-sm py-6 px-4">
                    <li className=" ">ایتم اول</li>
                    <li className=" ">ایتم دوم</li>
                    <li className=" ">ایتم دوم</li>
                    <li className=" ">ایتم دوم</li>
